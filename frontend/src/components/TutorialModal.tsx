...
const STEPS = [
  {
    ...
    title: '目録',
    subtitle: 'CATALOG',
    description: 'ゲーム内の全アイテム・ボス・NPCを一覧で確認できます。\n未登録のものに情報を追加したり、既存の情報を編集・校閲することができます。',
    link: '/catalog',
    linkLabel: '目録を見る →',
  ...
  },
  {
    ...
    description: '収録された画像と情報をカード形式で閲覧できます。\n考察コメントの投稿や、より良い画像への差し替えも可能です。',
    link: '/items',
    linkLabel: '図録を見る →',
  ...
  },
  {
    ...
    description: 'ボスやNPCの関係性をグラフで視覚的に整理できます。\n組織・協力・敵対などの関係を線で結び、世界観を俯瞰することができます。',
    link: '/relation-graph',
    linkLabel: '相関図を見る →',
  ...
  },
  {
    ...
    title: '掲示板',
    subtitle: 'BOARDS',
    description: 'ゲームごとの掲示板と総合掲示板があります。\n攻略情報の共有、考察の議論、プレイヤー同士の交流にご利用ください。',
    link: '/boards',
    linkLabel: '掲示板を見る →',
