    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-zinc-800 rounded-lg shadow p-6 mt-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">ボス名 *</label>
            <input
              type="text"
              value={form.name}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-200 mb-1">セリフ</label>
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              disabled={isEdit && !hasBossChanges}
